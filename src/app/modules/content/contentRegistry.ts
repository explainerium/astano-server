...
export const CONTENT_REGISTRY: Record<string, ContentDefinition> = {
	...
	"dealers.cards.0.image": { group: "dealers", section: "Cards", label: "Card 1 — picture", type: "image" },
	"dealers.cards.1.image": { group: "dealers", section: "Cards", label: "Card 2 — picture", type: "image" },
	"dealers.cards.2.image": { group: "dealers", section: "Cards", label: "Card 3 — picture", type: "image" },
	"dealers.cards.3.image": { group: "dealers", section: "Cards", label: "Card 4 — picture", type: "image" },
