...
export const CONTENT_SECTIONS: Record<string, string> = {
	...
	"shell/Header menu": "The links across the top of every page.",
	"shell/Footer links": "The two columns of links in the footer, on every page.",
...
export const CONTENT_REGISTRY: Record<string, ContentDefinition> = {
	...
	"nav.header.about": { group: "shell", section: "Header menu", label: "About us", type: "text" },
	"nav.header.contact": { group: "shell", section: "Header menu", label: "Contact", type: "text" },
	"nav.header.custom": { group: "shell", section: "Header menu", label: "Custom-made", type: "text" },
	"nav.header.faqs": { group: "shell", section: "Header menu", label: "FAQs", type: "text" },
	"nav.header.home": { group: "shell", section: "Header menu", label: "Home", type: "text" },
	"nav.header.products": { group: "shell", section: "Header menu", label: "Products", type: "text" },
	"nav.header.quality": { group: "shell", section: "Header menu", label: "Quality", type: "text" },
	"nav.footer.about": { group: "shell", section: "Footer links", label: "About us", type: "text" },
	"nav.footer.contact": { group: "shell", section: "Footer links", label: "Contact", type: "text" },
	"nav.footer.custom": { group: "shell", section: "Footer links", label: "Custom-made", type: "text" },
	"nav.footer.dealers": { group: "shell", section: "Footer links", label: "Dealers", type: "text" },
	"nav.footer.faqs": { group: "shell", section: "Footer links", label: "FAQs", type: "text" },
	"nav.footer.home": { group: "shell", section: "Footer links", label: "Home", type: "text" },
	"nav.footer.imprint": { group: "shell", section: "Footer links", label: "Imprint", type: "text" },
	"nav.footer.paymentShipping": { group: "shell", section: "Footer links", label: "Payment & shipping", type: "text" },
	"nav.footer.privacy": { group: "shell", section: "Footer links", label: "Privacy policy", type: "text" },
	"nav.footer.products": { group: "shell", section: "Footer links", label: "Product range", type: "text" },
	"nav.footer.quality": { group: "shell", section: "Footer links", label: "Quality", type: "text" },
	"nav.footer.terms": { group: "shell", section: "Footer links", label: "Terms and conditions", type: "text" },
